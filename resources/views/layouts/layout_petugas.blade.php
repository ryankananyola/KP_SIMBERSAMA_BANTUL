...
<head>
    ...
    <title>Petugas - SIMBERSAMA</title>
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar py-3 px-0">
            ...
            <ul class="nav flex-column px-2">
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->is('dashboard_petugas') ? 'active' : '' }}" href="/dashboard_petugas">
                ...
                <li class="nav-item mb-1">
                    <a class="nav-link {{ request()->routeIs('petugas.data_umum') ? 'active' : '' }}" 
                        href="{{ route('petugas.data_umum') }}">
                        <span class="material-icons">fact_check</span> Data Umum
                    </a>
                </li>
                <li class="nav-item mb-1">
                    <a class="nav-link {{ request()->routeIs('petugas.data_periodik') ? 'active' : '' }}" 
                        href="{{ route('petugas.data_periodik') }}">
