...
<div class="container-fluid p-4">
    <h1 class="h3 mb-4 fw-bold text-center">Detail Data User - {{ $akun->nama }}</h1>
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ $akun->email }}" readonly>
                </div>
                <div class="col-md-6">
            ...
            {{-- <div class="mt-4 text-end">
                <a href="{{ route('admin.dataumum') }}" class="btn btn-secondary">Kembali</a>
            </div> --}}
        </div>
    </div>
</div>
