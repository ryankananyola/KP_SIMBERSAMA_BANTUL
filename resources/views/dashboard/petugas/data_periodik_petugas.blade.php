...
<div class="container-fluid p-4">
    <h1 class="h3 mb-4 fw-bold text-center text-success">Data Periodik Bank Sampah</h1>
        ...
        <div class="card-body">
            <form action="{{ route('petugas.data_periodik') }}" method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-4 text-end">
                    ...
                    <a href="{{ route('petugas.data_periodik') }}" class="btn btn-outline-secondary px-4 shadow-sm">
                            ...
                            <tbody>
                                @foreach ($laporan as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('petugas.data_periodik.show', $item->id) }}" 
